            ...
            withCallingHandlers(
                {
                    maaslin_plot_results22(
                        ...
                        metadata, maaslin_results$fit_data_abundance,
                        maaslin_results$fit_data_prevalence, normalization,
                        transform, feature_specific_covariate, feature_specific_covariate_name,
                        feature_specific_covariate_record, median_comparison_abundance,
