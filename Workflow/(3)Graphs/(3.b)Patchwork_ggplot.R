...
####patch2 devo metterla?


#p1 = readRDS(file = "BACT_StackedBar_Species.rds") + theme(plot.margin = margin(t = 10, r = 10, b = 80, l = 10))  # Aumentare il margine inferiore
#p1 = p1 + guides(fill = guide_legend(ncol = 1), color = guide_legend(ncol = 1))
p2 = readRDS(file = "./NEW_PLOT_RDS/BACT_alpha_gc_treatment.rds") + theme(axis.text.x = element_blank(),
                                                                          axis.title.x = element_blank(),
                                                                          axis.ticks.x = element_blank())
p3 = readRDS(file = "./NEW_PLOT_RDS/BACT_beta_gc.rds") + theme(axis.text.x = element_text(size=24,face = "bold"))
#p4 = readRDS(file = "./NEW_PLOT_RDS/ARCH_StackedBar_Species.rds") + theme(plot.margin = margin(t = 10, r = 10, b = 80, l = 10)) 
#p4 = p4 + guides(fill = guide_legend(ncol = 1), color = guide_legend(ncol = 1))
p5 = readRDS(file = "./NEW_PLOT_RDS/ARCH_alpha_gc_treatment.rds") + theme(axis.text.x = element_blank(), 
                                                                          axis.title.x = element_blank(), 
                                                                          axis.ticks.x = element_blank())
p6 = readRDS(file = "./NEW_PLOT_RDS/ARCH_beta_gc.rds") + theme(axis.text.x = element_text(size=24, face = "bold"))
#p7 = readRDS(file = "./NEW_PLOT_RDS/EUK_StackedBar_Species.rds") + theme(plot.margin = margin(t = 10, r = 10, b = 80, l = 10)) 
#p7 = p7 + guides(fill = guide_legend(ncol = 1), color = guide_legend(ncol = 1))
p8 = readRDS(file = "./NEW_PLOT_RDS/EUK_alpha_gc_treatment.rds") + theme(axis.text.x = element_blank(), 
                                                                         axis.title.x = element_blank(),
                                                                         axis.ticks.x = element_blank())
p9 = readRDS(file = "./NEW_PLOT_RDS/EUK_beta_gc.rds") + theme(axis.text.x = element_text(size=24, face = "bold"))
...
ggsave("plot1b.png", plot = patchwork, width = 40, height = 30, dpi = 300)
