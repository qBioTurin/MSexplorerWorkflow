colors = c("#bad7f2", "#baf2d8", "#465362", "#b4436c", "#FDBF6F", "#edead0", 
           "#8ea4d2", "#4d9078", "#414073", "#fface4", "#ef6f6c", "#edead0", 
           "#1F78B4", "#c0df85", "#011936", "#ab87ff", "#f78154", "#c9b1bd", 
           "#ef2d56", "#7e1a2f", "#553555")
colors_10 = c("#8ea4d2", "#baf2d8", "#465362", "#ef6f6c", "#FDBF6F", "#edead0", 
              "#bad7f2", "#4d9078", "#414073", "#fface4", "#b4436c", "#edead0", 
              "#1F78B4", "#c0df85", "#011936", "#ab87ff", "#f78154", "#c9b1bd", 
              "#ef2d56", "#7e1a2f", "#553555")
colors_20 = c("#FDBF6F", "#465362", "#1F78B4","#bad7f2", "#ef6f6c", "#edead0", 
              "#8ea4d2", "#4d9078", "#414073", "#fface4", "#b4436c", "#edead0", 
              "#baf2d8", "#c0df85", "#011936", "#ab87ff", "#f78154", "#c9b1bd", 
              "#ef2d56", "#7e1a2f", "#553555")

colors_alpha = c("#bad7f2", "#baf2d8", "#465362", "#b4436c")

#colors_beta = c("#b4436c", "#baf2d8", "#465362", "#bad7f2")
colors_beta = c("#b4436c", "#bad7f2", "#465362", "#baf2d8", "#c9b1bd")

colors_venn = c( "#ef6f6c", "#8ea4d2")
colors_venn3 = c( "#ef6f6c", "#8ea4d2", "#edead0")
colors_venn4 = c( "#F37651","#F6B48E")
#f78381

# Stool "#2B1700", lung "#edead0"
# metaphlan #f78381ff, kraken #bad7f2ff

colors_EDA2 = c("#B6D1C9", "#5D6771")
